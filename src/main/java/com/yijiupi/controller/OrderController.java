...
public ResponseEntity<PageInfo> queryOrderByCityId(@PathVariable (value = "pageNu") Integer pageNum, @RequestParam(value = "pageSize",defaultValue = "2") Integer pageSize, @PathVariable(value = "cityId") Integer cityId) {
